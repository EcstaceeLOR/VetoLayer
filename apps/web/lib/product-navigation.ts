...
export const productNavigation: ProductNavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Data", href: "/dashboard/data", description: "Exports, retention, ownership transfer, and offboarding", icon: "overview" },
      { label: "Plan & Usage", href: "/dashboard/billing", description: "Workspace plan, entitlements, and real usage", icon: "overview" },
